...
class Hello(object):
    ...
    # rotate to engage
    ctx.rotate(-pi/2-pi/n_g5+(pi+pi/n_g1)*n_g1/n_g5)
    # put it back
    ctx.translate(-x_g5, -y_g5)
    ...
    '''
        ...
        return outstring
    #@+node:.20150622202324.1: *3* mygeartest3
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def mygeartest3(self , M=5, P=15,N1=15, N2=24,N3=15,N4=24 ):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    ctx.translate(x_g4, y_g4)
    # rotate to engage
    ctx.rotate(pi/2-pi/n_g4+(pi+pi/n_g3)-n_g4-n_g3/pi)
    # put it back
    ctx.translate(-x_g4, -y_g4)
    spur.Spur(ctx).Gear(x_g4, y_g4, rp_g4, n_g4, pa, "pink")
    ctx.restore()
